...
- [Linear polarization](../examples/backgrounds/example_making_initial_profile_linear.ipynb) — single-field configuration with no self-interaction, $\gamma = 0$.
- [Radial polarization](../examples/backgrounds/example_making_initial_profile_radial.ipynb) — single-field configuration with no self-interaction, $\gamma = 1$.
